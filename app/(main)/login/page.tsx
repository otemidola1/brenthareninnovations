    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (result?.error) {
                ...
                // Successful login
                router.refresh()
                router.push("/") // Redirect to home, Navbar will show appropriate links
            }
        } catch (err) {
        ...
        <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-gray-50 h-screen">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                ...
                <p className="mt-10 text-center text-sm text-gray-500">
                    Not a member?{" "}
                    <Link href="/register" className="font-semibold leading-6 text-lemon-green hover:text-lime-500">
                        Create an account
                    </Link>
                </p>
            </div>
